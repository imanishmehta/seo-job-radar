...
The dashboard starts with a researched employer watchlist. It is **not a complete Google-wide index**. Some employers block crawlers, require JavaScript rendering or use unsupported ATS systems. The Career sources screen reports these gaps instead of implying there are no vacancies.
